    ...
    <div className="min-h-screen flex items-center justify-center bg-[#14161b] px-4">
      <div className="w-full max-w-100">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-zinc-400 text-sm mt-1">로그인하고 거래를 시작하세요</p>
        </div>

        {/* 세션 만료 안내 */}
        {info && (
          <div className="mb-4 flex items-center gap-2 px-4 py-3 rounded-lg bg-[#F59E0B]/10 border border-[#F59E0B]/30">
            <span className="text-[#F59E0B] text-lg">⚠</span>
            <p className="text-[#F59E0B] text-sm">{info}</p>
          </div>
        )}
